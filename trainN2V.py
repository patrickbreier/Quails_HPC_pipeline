#!/projects/Quails/sw/envs/newN2V/bin/python
...
# We will load all the '.tif' files from the 'data' directory. Input depends on the parameter given by the bash-script
...
# plt.figure(figsize=(16,5)) # creates error couldn't connect to localhost. is there a different way to set this?
plot_history(history, ['loss', 'val_loss'])
plt.savefig(basedir + '/model_loss.png')
